...
public class SaleWithSalesmanEvent implements Serializable {
    ...
    public SaleWithSalesmanEvent(String eventId, String traceId, int saleId, int salesmanId, String salesmanName, String saleDate, int productId, int storeId, int quantity) {
