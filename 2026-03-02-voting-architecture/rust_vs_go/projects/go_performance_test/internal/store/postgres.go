...
func (p *PostgresStore) CheckPollAndOption(pollID, optionID uint32) error {
	var isOpen bool
	var exists bool
...
func (p *PostgresStore) GetOption(id uint32) (*models.OptionItem, bool) {
...
func (p *PostgresStore) GetPollSnapshot(id uint32) (PollSnapshot, bool) {
...
func (p *PostgresStore) ListOptions(pollID uint32) []models.OptionItem {
	var rows *sql.Rows
	var err error
	if pollID == 0 {
...
func (p *PostgresStore) CreatePoll(id uint32, question string, isOpen bool) error {
...
func (p *PostgresStore) UpdatePoll(id uint32, question string, isOpen bool) error {
...
func (p *PostgresStore) DeletePoll(id uint32) error {
...
func (p *PostgresStore) AddOption(pollID, optionID uint32, label string) error {
	var tmp uint32
...
func (p *PostgresStore) UpdateOption(optionID uint32, label string) error {
...
func (p *PostgresStore) DeleteOption(optionID uint32) error {
...
func (p *PostgresStore) AddVoter(pollID uint32, voterID string) error {
	var tmp uint32
	if err := p.db.QueryRow(`select id from polls where id=$1`, pollID).Scan(&tmp); err != nil {
		if err == sql.ErrNoRows {
			return errors.New("poll not found")
...
func (p *PostgresStore) DeleteVoter(pollID uint32, voterID string) error {
